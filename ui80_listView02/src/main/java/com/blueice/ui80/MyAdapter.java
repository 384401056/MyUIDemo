...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ((TextView)convertView.findViewById(R.id.list_tv02)).setText("users.get(position).getName().toString()");
        (convertView.findViewById(R.id.list_linear01)).setVisibility(users.get(position).getIsOpen()?View.VISIBLE : View.GONE);
